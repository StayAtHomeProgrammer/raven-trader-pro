...
class SwapTransaction():
    ...
    def sign_partial(self):
        # TODO: Im pretty sure i have to make changes here
        ...
        signed_raw = do_rpc("signrawtransaction", hexstring=raw_tx, prevtxs=None, privkeys=None,
    ...
    def complete_order(self, swap_storage):
        ...
        if self.type == "sell":
            ...
            quick_fee = 2 * (0.01 * len(
                self.raw) / 2 / 1024)  # Double the cost of the 1vin:1vout should be good enough to find a utxo set
